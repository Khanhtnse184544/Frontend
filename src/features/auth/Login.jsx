    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center px-4 py-6 md:px-0">
      ...
      <div className="relative bg-white rounded-3xl md:rounded-[50px] shadow-[0_4px_20px_rgba(0,0,0,0.1)] w-full max-w-[500px] mx-auto overflow-hidden border border-gray-100">
        ...
        <div className="px-6 py-8 md:px-10 md:py-12 relative z-10">
          ...
          {/* Form Container */}
          <form className="mt-4 space-y-5 md:space-y-6 flex flex-col items-center">
            ...
            <button
              type="submit"
              className="w-full md:w-[80%] py-3 bg-[#1E2C34] text-white rounded-xl font-semibold hover:bg-[#2E424E] transition-colors shadow-md text-base md:text-lg"
            >
              Đăng nhập
            </button>
          </form>
          ...
          <div className="mt-8 space-y-3 flex flex-col items-center">
            <button className="w-full md:w-[70%] flex items-center justify-center gap-3 py-2.5 bg-gray-50 border border-gray-200 rounded-xl hover:bg-gray-200 transition-colors">
